        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 max-w-6xl mx-auto">
          {reasons.map((reason, index) => (
            <motion.div
              ...
              className="p-6 text-center border border-border/50 dark:border-border/70 rounded-[6px] bg-card"
            >
              <div className="inline-flex items-center justify-center w-14 h-14 rounded-[6px] bg-secondary/10 mb-5">
                <reason.icon className="w-7 h-7 text-secondary" strokeWidth={1.5} />
              </div>
              <h3 className="font-display text-lg font-semibold mb-3 text-primary">{reason.title}</h3>
